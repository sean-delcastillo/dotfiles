...
(setq user-full-name "Sean Del Castillo"
      user-mail-address "seanbdcastillo@gmail.com")
...
(setq doom-big-font "Iosevka Term-25")
...
(after! org
  (let ((default-directory "~/Documents/org-files/"))
    (setq org-capture-templates
        '(("i" "Capture to Inbox" entry (file "~/Documents/org-files/gtd/inbox.org")
           "* TODO %?\n %i\n")))))
  ...
  (map! :leader
      ...
      (:prefix-map ("g" . "gtd")
                   (:prefix ("f" . "files")
                    ...
                    :desc "Open GTD Review Box" "r" #'(lambda () (interactive) (find-file-other-window "~/Documents/org-files/gtd/review.org"))
                    :desc "Open GTD Tasks Box" "t" #'(lambda () (interactive) (find-file-other-window "~/Documents/org-files/gtd/tasks.org"))))
      (:prefix-map ("c". "citar")
